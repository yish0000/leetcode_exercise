...
RUN_TESTCASE(AddOneRowToTree)
{
	...
	vector<string> res1 = { "4","1","1","2","null","null","6","3","1","5","null" };
	TreeNode* tree1 = sln.MakeTree(arr1);
	tree1 = sln.addOneRow(tree1, 1, 2);
	TESTCASE_ASSERT(sln.TreeEqual(tree1, res1));
	sln.FreeTree(tree1);

	vector<string> arr2 = { "4","2","null","3","1" };
	vector<string> res2 = { "4","2","null","1","1","3","null","null","1" };
	...
	vector<string> res3 = { "1","2","3","4","null","null","null","5","5" };
